...
router.get('/confirm_booking/:id', validate(session_only_id_dto, 'params'), auth, async (req, res) => {
...
router.patch('/cancel_session/:id', validate(session_only_id_dto, 'params'), auth, async (req, res) => {
...
router.delete('/confirm_cancellation/:id', validate(session_only_id_dto, 'params'), auth, async (req, res) => {
    const user_id = req.user.id;
